...
$resourceGroupName = "Sandeep-rg"  #provide resource group name
...
$templateFileURI = 'https://raw.githubusercontent.com/oi14sn85/CIaCSTrainingARM/main/ContosoFinance-Demo-ARM/ARM-Templates/template.json'
$parametersFileURI = 'https://raw.githubusercontent.com/oi14sn85/CIaCSTrainingARM/main/ContosoFinance-Demo-ARM/ARM-Templates/paramters.json'
